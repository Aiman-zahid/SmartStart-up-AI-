...
from startup_data import build_combined_startup_dataset, load_existing_combined_dataset
...
def get_trained_models():
    ...
    existing = load_existing_combined_dataset()
    if existing is not None:
        combined, training_df = existing
    else:
